...
(function($){
    $.fn.spinwheel = function(options, callback){
        ...
        $.each(pplArray, function(key, value){
            $("#suggest").append("<li class='def-item'><span>" + value + "</span><button class='rm-def'>x</button></li>");
        });
        $("#suggest").append("</ul>");

        $('.rm-def').click(function(){
            alert('test');
            console.log(pplArray[0]);
        });
    ...
    $.fn.spinwheel.default_options = {
        ...
        wheelBorderColor: 'black',wheelBorderWidth : 3, wheelTextFont : 'bold 15px sans-serif', wheelTextColor: 'white', wheelTextShadowColor : 'rgb(220,220,220)',
...
$(document).ready(function(){
    ...
    $('.canvas').spinwheel({
        pplArray :["Media Campus","Schlachthof","Coop","Pasta","Pizzeria","Singapur","Barbecue","Try again :-)"]
    });
